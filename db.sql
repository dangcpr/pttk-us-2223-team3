...
/*
 Thay đổi ràng buộc của cột MA_PHIEU từ INT thành ( INT IDENTITY(1,1) NOT NULL )
 Thay đổi tên cột SO_DEM_O thành cột NGAY_CHECK_IN
*/
ALTER TABLE PHIEU_DANG_KY
DROP CONSTRAINT FK_PHIEU_DANG_KY_TAI_KHOAN;
go
ALTER TABLE PHIEU_DANG_KY
DROP CONSTRAINT PK_PHIEU_DANG_KY_KHACH_HANG;
go
ALTER TABLE PHIEU_DANG_KY
DROP COLUMN MA_PHIEU;
GO
...
ALTER TABLE PHIEU_DANG_KY
ADD CONSTRAINT PK_PHIEU_DANG_KY_KHACH_HANG PRIMARY KEY CLUSTERED (MA_PHIEU ASC, MA_KHACH_HANG ASC),
    CONSTRAINT FK_PHIEU_DANG_KY_TAI_KHOAN FOREIGN KEY (MA_KHACH_HANG) REFERENCES dbo.TAI_KHOAN(USERNAME);
GO
