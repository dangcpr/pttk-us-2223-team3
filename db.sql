...
CREATE TABLE THONG_TIN_DANG_KY_DICH_VU (
	...
	CONSTRAINT PK_THONG_TIN_DANG_KY_DICH_VU PRIMARY KEY (MA_DICH_VU, MA_KHACH_HANG)
)
GO
...
CREATE TABLE HOA_DON (
	...
	FOREIGN KEY(LE_TAN_GHI_NHAN) REFERENCES TAI_KHOAN(USERNAME)
)
...
CREATE TABLE CHI_TIET_HOA_DON (
	...
	THANH_TIEN INT NOT NULL,
	PRIMARY KEY(MA_HOA_DON,MA_DICH_VU,MA_KHACH_HANG),
	FOREIGN KEY(MA_HOA_DON) REFERENCES HOA_DON(MA_HOA_DON),
	FOREIGN KEY(MA_DICH_VU,MA_KHACH_HANG) REFERENCES THONG_TIN_DANG_KY_DICH_VU(MA_DICH_VU,MA_KHACH_HANG)
)
...
INSERT INTO PHIEU_THONG_TIN_DAT_PHONG (MA_DP, MA_PHONG, MA_KHACH_HANG, MA_NV_GHI_NHAN) VALUES (1, 1, 'khachhang1', 'letan1');
...
VALUES (N'Dịch vụ phòng', 'Phòng', 'Tất cả', 100000, N'Dịch vụ phòng chăm sóc khách hàng', 'Hoạt động')

INSERT INTO DICH_VU (TEN_DICH_VU, LOAI, LOAI_PHONG_CHO_PHEP, GIA_TIEN, MO_TA, TINH_TRANG)
VALUES (N'Dịch vụ đỗ xe', 'Tiện ích', 'Tất cả', 50000, N'Dịch vụ đỗ xe miễn phí cho khách hàng', 'Hoạt động')

INSERT INTO DICH_VU (TEN_DICH_VU, LOAI, LOAI_PHONG_CHO_PHEP, GIA_TIEN, MO_TA, TINH_TRANG)
VALUES (N'Dịch vụ nhà hàng', 'Tiện ích', 'Tất cả', 150000, N'Dịch vụ nhà hàng phục vụ bữa ăn', 'Hoạt động')

INSERT INTO DICH_VU (TEN_DICH_VU, LOAI, LOAI_PHONG_CHO_PHEP, GIA_TIEN, MO_TA, TINH_TRANG)
VALUES (N'Dịch vụ giặt là', 'Tiện ích', 'Tất cả', 80000, N'Dịch vụ giặt là và là ủi quần áo', 'Hoạt động')

INSERT INTO DICH_VU (TEN_DICH_VU, LOAI, LOAI_PHONG_CHO_PHEP, GIA_TIEN, MO_TA, TINH_TRANG)
VALUES (N'Dịch vụ spa', 'Tiện ích', 'Phòng đôi', 250000, N'Dịch vụ spa chăm sóc sức khỏe và làm đẹp', 'Hoạt động')
...
VALUES (2, 'khachhang1', '2023-05-27', 2, 100000, 'Đã thanh toán')

INSERT INTO THONG_TIN_DANG_KY_DICH_VU (MA_DICH_VU, MA_KHACH_HANG, NGAY, SO_LUONG, THANH_TIEN, TINH_TRANG_THANH_TOAN)
VALUES (1, 'khachhang1', '2023-05-27', 1, 100000, 'Đã thanh toán')

INSERT INTO THONG_TIN_DANG_KY_DICH_VU (MA_DICH_VU, MA_KHACH_HANG, NGAY, SO_LUONG, THANH_TIEN, TINH_TRANG_THANH_TOAN)
VALUES (5, 'khachhang1', '2023-05-26', 3, 750000, 'Chưa thanh toán')

INSERT INTO THONG_TIN_DANG_KY_DICH_VU (MA_DICH_VU, MA_KHACH_HANG, NGAY, SO_LUONG, THANH_TIEN, TINH_TRANG_THANH_TOAN)
VALUES (4, 'khachhang1', '2023-05-25', 1, 80000, 'Đã thanh toán')

INSERT INTO THONG_TIN_DANG_KY_DICH_VU (MA_DICH_VU, MA_KHACH_HANG, NGAY, SO_LUONG, THANH_TIEN, TINH_TRANG_THANH_TOAN)
VALUES (3, 'khachhang1', '2023-05-25', 2, 300000, 'Chưa thanh toán')
