...
select * from DICH_VU
INSERT INTO DICH_VU values ( 'Karaoke', 'VIP', N'Tất cả', 300000, '', N'Còn')
INSERT INTO DICH_VU values ( 'Bi-a', 'VIP', N'Vip', 99000, '', N'Còn')

SELECT * FROM THONG_TIN_KHACH_HANG WHERE MA_KHACH_HANG = 'khachhang1'
SELECT * FROM THONG_TIN_KHACH_HANG WHERE MA_KHACH_HANG = 'khachhang1' AND CCCD = '123'
SELECT * FROM PHIEU_DANG_KY


INSERT INTO KHUYEN_MAI VALUES (N'Giảm 10% tổng hóa đơn', '2023-6-18', '2023-7-18')
INSERT INTO THONG_TIN_DAT_PHONG (MA_KHACH_HANG, NGAY_DAT, LOAI_PHONG, NGAY_CHECKIN, NGAY_CHECKOUT, KHUYEN_MAI) 
VALUES ('khachhang', '2023-5-26', N'Thường', '2023-6-2', '2023-6-4', '1');

select TT.MA_KHACH_HANG, KM.* from THONG_TIN_DAT_PHONG TT, KHUYEN_MAI KM WHERE TT.MA_KHACH_HANG = 'khachhang1'
select * from THONG_TIN_DAT_PHONG
select * from KHUYEN_MAI

UPDATE KHUYEN_MAI
SET NOI_DUNG = N'Giảm 10% tổng hóa đơn'

SELECT TT.MA_KHACH_HANG, KM.* FROM THONG_TIN_DAT_PHONG TT, KHUYEN_MAI KM WHERE TT.MA_KHACH_HANG = 'khachhang1' AND KM.MA_KHUYEN_MAI = TT.KHUYEN_MAI
SELECT * FROM THONG_TIN_KHACH_HANG WHERE MA_KHACH_HANG = 'khachhang1'



delete  from LICH_SU_DUNG_DICH_VU
SELECT * from THONG_TIN_DANG_KY_DICH_VU
SElect * from THONG_TIN_DAT_PHONG

select * from DICH_VU WHERE TEN_DICH_VU = 'Bi-a' AND (LOAI_PHONG_CHO_PHEP = N'Tất cả' OR LOAI_PHONG_CHO_PHEP IN (SELECT LOAI_PHONG FROM THONG_TIN_DAT_PHONG WHERE MA_KHACH_HANG = 'khachhang1'))
SELECT DK.ID, DV.TEN_DICH_VU, DK.MA_KHACH_HANG, DK.NGAY, DK.SO_LUONG, DK.THANH_TIEN, DK.TINH_TRANG_THANH_TOAN FROM THONG_TIN_DANG_KY_DICH_VU DK, DICH_VU DV WHERE MA_KHACH_HANG = '{makh}' AND DK.MA_DICH_VU = DV.MA_DICH_VU